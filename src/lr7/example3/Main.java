...
public class Main {
    public static void main(String[] args) {
        SuperClassTask3 superClassTask3 = new SuperClassTask3(570);
        System.out.println(superClassTask3.toString());
        SubClassTask3 subClassTask3 = new SubClassTask3(78, 'd');
        System.out.println(subClassTask3.toString());
        SubClass2Task3 subClass2Task3 = new SubClass2Task3(61, 'R', "Аргумент");
        System.out.println(subClass2Task3.toString());
        subClass2Task3.setNum(12, 'h', "Hello");
        System.out.println(subClass2Task3.toString());
    }
}
